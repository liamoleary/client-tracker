  ...
  function buildDetailsPanel(project) {
    ...
    if (weekGroups.length > 0) {
      ...
      inv.innerHTML =
        ...
        `<div class="fortnight-amount">${formatHM(invoiceSec)} &middot; ${formatDays(invoiceSec)} &middot; <strong>${fmtMoney(calcEarnings(invoiceSec, project.daily_rate))}</strong></div>`;
